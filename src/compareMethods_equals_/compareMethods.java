...
//=====================================
//
//2. If we want to compare ONLY with empty string, without worrying about null values.
//NOTE: The empty string ("") should be first object. The second string object ("text"), can have string value, can be empty or null (without exception).
//======================
//if ("".equals(text)) {
// }
//======================
